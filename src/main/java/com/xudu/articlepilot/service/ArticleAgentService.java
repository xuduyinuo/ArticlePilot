...
import com.xudu.articlepilot.annotation.AgentExecution;
import com.xudu.articlepilot.constant.PromptConstant;
import com.xudu.articlepilot.model.dto.article.ArticleState;
import com.xudu.articlepilot.model.dto.image.ImageRequest;
...
public class ArticleAgentService {
    ...
    public void executePhase2_GenerateOutline(ArticleState state, Consumer<String> streamHandler) {
        try {
            ...
            // 通过代理调用，使 AOP 生效
            getProxy().agent2GenerateOutline(state, streamHandler);            streamHandler.accept(SseMessageTypeEnum.AGENT2_COMPLETE.getValue());
